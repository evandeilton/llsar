...
```{r, fig.pos="h", fig.align='center', fig.height=8, fig.width=12, fig.cap="Mapa de ocorrências de tiroteio"}
...
```{r, fig.pos="h", fig.align='center', fig.height=8, fig.width=12, fig.cap="Matriz de adjacências entre bairros do Rio de Janeiro"}
